...
const DockItem = ({ icon: Icon, label, href, isAnimated = true }: DockItemProps) => {
    ...
    return (
        ...
        >
            <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-white border border-neutral-200 shadow-lg dark:bg-neutral-800 dark:border-neutral-700">
                <Icon
                    ref={iconRef}
                    size={28}
            ...
            <motion.div
                ...
                className="absolute pointer-events-none whitespace-nowrap rounded-lg bg-neutral-900/90 px-3 py-1.5 text-xs font-medium text-white shadow-xl dark:bg-neutral-100/90 dark:text-neutral-900"
            >
                {label}
            </motion.div>
        </motion.a>
